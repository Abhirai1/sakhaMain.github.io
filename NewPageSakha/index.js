...
document.getElementById("btncol1").onclick = function() {
    console.log("hi");
    document.getElementById("textarea").innerHTML = "What is the purpose of life ?";

};

document.getElementById("btncol2").onclick = function() {
    console.log("hi");
    document.getElementById("textarea").innerHTML = "What is relationship ?";

};

document.getElementById("btncol3").onclick = function() {
    console.log("hi");
    document.getElementById("textarea").innerHTML = "What is life ?";

};

document.getElementById("btncol4").onclick = function() {
    console.log("hi");
    document.getElementById("textarea").innerHTML = "What is soul ?";

};

document.getElementById("btncol5").onclick = function() {
    console.log("hi");
    document.getElementById("textarea").innerHTML = "What is happiness ?";
